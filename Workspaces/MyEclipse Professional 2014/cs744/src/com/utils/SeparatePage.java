...
public class SeparatePage {
	...
	private void createSeparateString(){
		...
		if (pageNo == 1){
			...
			sb.append("<a href='" + callUrl + "?pageNo=" + (pageNo - 1) + "&pageSize=" + pageSize + keysAndValues + "'>previoes page</a> &nbsp;&nbsp;");
		}
		...
		sb.append("if (isNaN(pageNo)){alert('wrong number');return false;}else{");
		
		sb.append("if (pageNo < 1 || pageNo > " + totalPage + "){alert('wrong nuber');return false;}else{");
